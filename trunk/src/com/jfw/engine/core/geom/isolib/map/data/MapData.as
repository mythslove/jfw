...
{
	import com.pianfeng.engine.isolib.isometric.IsoUtils;
	import com.pianfeng.engine.isolib.isometric.Point3D;
	...
	public class MapData implements IMapData
	{
		...
		public function MapData(xml:XML)
		{
			...
			loadGridData(xml);
			//更新坐标系原点便宜量
			var p3d:Point3D=IsoUtils.screenToIso(new Point(this._bgWidth/2,(this._bgHeight-this._cellSize*this._gridRows)/2));
