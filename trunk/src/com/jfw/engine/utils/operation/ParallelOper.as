package com.jfw.engine.utils.operation
{
	...
	[Event(name="child_operation_start",type="com.jfw.engine.utils.operation.OperationEvent")]
	[Event(name="child_operation_complete",type="com.jfw.engine.utils.operation.OperationEvent")]
	[Event(name="child_operation_error",type="com.jfw.engine.utils.operation.OperationEvent")]
	/**
	 * 固定数量并发执行 
	 * 
	 */
