package examples
{
	import com.jfw.engine.core.animation.BmdAtlas;
	import com.jfw.engine.core.animation.BmdMovieClip;
	import com.jfw.engine.core.animation.Juggler;
	...
	public class BmdMovieClipTest extends Sprite
	{
		...
		public function BmdMovieClipTest()
		{
			...
			for( var i:int = 0; i<10;i++)
			{
				...
				var frames:Vector.<BitmapData> = bmdAtlas.getTextures("rightDown_walk_");
