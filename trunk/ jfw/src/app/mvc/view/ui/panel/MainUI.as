package app.mvc.view.ui.panel
{
	...
	public class MainUI extends BPanel
	{
		...
		private function resetPosition( ):void
		{
			...
			this.$mcTopPanel.x = this.stage.stageWidth - this.$mcTopPanel.width >> 1;
			this.$mcTopPanel.y = this.$mcRoleInfo.y;
			
			this.$mcCd.x = this.$mcRoleInfo.x;
			this.$mcCd.y = this.$mcRoleInfo.y + this.$mcRoleInfo.height + 20;
			
			this.$mcTask.x = this.$mcRoleInfo.x;
			this.$mcTask.y = this.$mcCd.y + 50;
			
			this.$mcGiftPanel.y = this.$mcRoleInfo.y;
			this.$mcGiftPanel.x = this.stage.stageWidth - this.$mcGiftPanel.width - 3;
		}
