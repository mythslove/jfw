package com.jfw.engine.motion.center
{
	 ...
	 * 
	 */	
	public class AsynCenterAnimation extends Sprite implements IAnimation
	{
		private var _motion:IAnimation=null;
		protected var _originX:Number=0;
		protected var _originY:Number=0;
		
		public function AsynCenterAnimation(srcid:String,manager:IResourceManager,frameName:String,defaultTextures:BitmapData,fps:Number=12)
		{
			_motion=new CenterAnimation(srcid,manager,frameName,defaultTextures,fps);
