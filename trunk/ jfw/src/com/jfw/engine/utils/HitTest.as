...
//			return intersection;
		...
		public static function hitTestObject(obj1:DisplayObject,obj2:DisplayObject,alpha:Number=1):Boolean
		{
			var at:BitmapData=getTransBitmapData(obj1);
			var st:BitmapData=getTransBitmapData(obj2);
			var apt:Point=obj1.parent.localToGlobal(new Point(obj1.x,obj1.y));	
			var spt:Point=obj2.parent.localToGlobal(new Point(obj2.x,obj2.y));	
			return at.hitTest(apt,alpha,st,spt);
		}
	}
}