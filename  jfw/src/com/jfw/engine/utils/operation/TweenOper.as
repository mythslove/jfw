...
{
	import com.jfw.engine.utils.ReflectUtil;
	import com.jfw.engine.utils.easing.TweenEvent;
	import com.jfw.engine.utils.easing.TweenUtil;
	import com.jfw.engine.utils.operation.effect.IEffect;
	...
	public class TweenOper extends Oper implements IEffect
	{
		...
		public function TweenOper(target:*=null,duration:int=100,params:Object=null,invert:Boolean = false,clearTarget:* = 0,immediately:Boolean = false)
		{
			super();
