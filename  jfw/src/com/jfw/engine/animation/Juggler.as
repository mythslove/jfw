package com.jfw.engine.animation
{
	...
	import com.jfw.engine.animation.helper.Tween;
	...
	public class Juggler implements IAnimatable
	{
		...
		public function add(object:IAnimatable):void
		{
			...
			if (dispatcher) 
				dispatcher.addEventListener(JugglerEvent.REMOVE_FROM_JUGGLER, onRemove);
		}
		...
		private function onRemove(event:JugglerEvent):void
		{
