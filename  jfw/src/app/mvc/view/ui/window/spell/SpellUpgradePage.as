package app.mvc.view.ui.window.spell
{
	...
	public class SpellUpgradePage extends BPanel
	{
		...
		public var $txSpellUpgradeName:TextField;
		public var $mcSpellIcon:MovieClip;
		public var $mcItems:MovieClip;
		public var $pbSpellUpgrade:MovieClip;
		...
		override protected function onInit():void{
			...
			FontUtil.setText( $txSpellUpgradeName,'妖将法术' );
			FontUtil.setText( $pbSpellLevelUp['$txName'],'升级' );
			this.setBindings();
		}
